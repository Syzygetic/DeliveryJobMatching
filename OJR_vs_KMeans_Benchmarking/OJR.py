...
# alljobtradingjobsgdf.plot(ax=ax, markersize=20, color='black', marker='^', label='Job Trading Jobs')
...
print("Outbound Job Recommender Cluster Entropy:", OJR_entropy)
end = time.time()
print("Outbound Job Recommender Run Time:", end - start)
